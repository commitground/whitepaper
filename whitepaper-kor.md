...
그래서 우리는 **커뮤니티에 의한 가치평가**를 구현하기 위하여 Gerritium 화폐와 그 채굴시스템인 Plant System을 제공합니다. 이것은 인센티브가 존재하는 오픈소스 커뮤니티로 이해할 수 있습니다. 다양한 구성원들로부터 좋은 평가를 많이 받을수록 큰 가치를 인정받을  수 있으며 어뷰징은 그 가치를 인정받지 못합니다.
